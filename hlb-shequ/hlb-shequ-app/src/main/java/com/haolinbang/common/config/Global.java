package com.haolinbang.common.config;
...
import com.haolinbang.common.utils.PropertiesLoader;
...
public class Global {
	...
	private static final String CONFIG_FILE = "file:" + System.getProperty("catalina.home") + "/myconf/config-sehqu.properties";
	...
	public static String getUserfilesBaseDir() {
		// 如果配置的路径存在，就使用配置的路径，否则在项目路径下
		String dir = getConfig("filefolder.share.images");
