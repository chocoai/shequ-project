package com.haolinbang.modules.act.service.activiti;
...
public class WorkflowTraceService {
	...
	private Map<String, Object> packageSingleActivitiInfo(ActivityImpl activity, ProcessInstance processInstance, boolean currentActiviti) throws Exception {
		...
		vars.put("activitiId", activity.getId());
		vars.put("procDefinitionId", processInstance.getProcessDefinitionId());
	 ...
	 * @return
	 */
	public List<Map<String, Object>> traceProcess2(String procDefId) {
		...
		List<Map<String, Object>> activityInfos = new ArrayList<Map<String, Object>>();
		for (ActivityImpl activity : activitiList) {
			Map<String, Object> activityImageInfo = packageSingleActivitiInfo(activity, procDefId);
			activityInfos.add(activityImageInfo);
		}
		return activityInfos;
	}
	 ...
	 * @return
	 */
	private Map<String, Object> packageSingleActivitiInfo(ActivityImpl activity, String procDefId) {
		...
		vars.put("任务类型", WorkflowUtils.parseToZhType(properties.get("type").toString()));
		vars.put("activitiId", activity.getId());
		vars.put("procDefinitionId", procDefId);
