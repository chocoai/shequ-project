package com.haolinbang.modules.act.utils;
...
import com.haolinbang.common.annotation.FieldName;
...
public class ActUtils {
	...
	public static final String[] PD_REPAIR = new String[] { "test_repair_task", "wy_repair" };
