...
public interface WyReBizActDao extends CrudDao<WyReBizAct> {
	...
	WyReBizAct getWyReBizAct(@Param("source") String source, @Param("groupId") String groupId, @Param("bizId") String bizId, @Param("actId") String actId);

	WyReBizAct getDefaultWyReBizAct(@Param("source") String source, @Param("groupId") String groupId, @Param("bizId") String bizId);

	List<WyReBizAct> getWyReBizActByBizid(@Param("source") String source, @Param("groupId") String groupId, @Param("bizId") String bizId);
