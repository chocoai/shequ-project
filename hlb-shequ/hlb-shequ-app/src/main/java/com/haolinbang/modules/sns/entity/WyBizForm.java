...
public class WyBizForm extends DataEntity<WyBizForm> {
	...
	private String formTypeAndName;// 显示名称和类型

	public String getFormTypeAndName() {
		return formTypeAndName;
	}

	public void setFormTypeAndName(String formTypeAndName) {
		this.formTypeAndName = formTypeAndName;
	}
	...
	@Length(min = 0, max = 32, message = "表单类型长度必须介于 0 和 32之间")
