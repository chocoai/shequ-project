 ...
 * @version 2017-05-18
 */
public class WyRepairSettlementLabor extends DataEntity<WyRepairSettlementLabor> {
	...
	public WyRepairSettlementLabor() {
		super();
	}

	public WyRepairSettlementLabor(String id){
		super(id);
	}
