 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/sns/wyRepairSettlementLabor")
public class WyRepairSettlementLaborController extends BaseController {
	...
	@RequiresPermissions("sns:wyRepairSettlementLabor:view")
	...
	@RequiresPermissions("sns:wyRepairSettlementLabor:edit")
