...
public class HlbregisterUtils {
	...
	public static String getValue(String key) {
		...
		userHlbregister.setSource(user.getSource());
		userHlbregister.setSubsystem("hlb_app");
		...
		if (StringUtils.isBlank(value)) {
			...
			sysHlbregister.setSubsystem("hlb_app");
	...
	public static void saveValue(String key, String value) {
		...
		hlbregister.setSource(user.getSource());
		hlbregister.setSubsystem("hlb_app");
