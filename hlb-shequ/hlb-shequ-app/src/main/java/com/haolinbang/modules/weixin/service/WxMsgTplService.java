...
public class WxMsgTplService extends CrudService<WxMsgTplDao, WxMsgTpl> {
	...
	public WxMsgTpl getWxMsgTplByCommonTplIdAndAccountId(Integer tplId, String accountId) {
		return wxMsgTplDao.getWxMsgTplByCommonTplIdAndAccountId(tplId, accountId);
	}
