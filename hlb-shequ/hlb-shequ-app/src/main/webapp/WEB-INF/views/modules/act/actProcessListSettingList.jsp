		...
		<tbody>
			<c:forEach items="${page.list}" var="object">
				...
				<tr>
					...
					<td>${process.name}</td>
					<td>
						<a href="javascript:updateCategory('${process.id}', '${process.category}')" title="点击设置分类">					
					...
					<td style="text-align: center;"><fmt:formatDate value="${deployment.deploymentTime}" pattern="yyyy-MM-dd"/></td>					
