...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sns/testData/">选项表列表</a></li>
		<li class="active"><a href="${ctx}/sns/testData/form?id=${testData.id}">选项表<shiro:hasPermission name="sns:testData:edit">${not empty testData.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sns:testData:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="testData" action="${ctx}/sns/testData/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="sns:testData:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
