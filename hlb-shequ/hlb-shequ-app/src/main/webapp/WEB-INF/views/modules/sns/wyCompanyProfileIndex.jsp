...
<body>
	...
	<div id="content" class="row-fluid">
		...
		<div id="right">
			<iframe id="officeContent" src="${ctx}/sns/wyCompanyProfile/index" width="100%" height="91%" frameborder="0"></iframe>
		</div>
	</div>
	<script type="text/javascript">
		var setting = {
			...
			callback:{onClick:function(event, treeId, treeNode){			
					...
					$('#officeContent').attr("src","${ctx}/sns/wyCompanyProfile/index?gid="+id+"&source="+source);
				}
			},
			//获取json数据  
	        async : {    
		...
		function refreshTree(){
			$.getJSON("${ctx}/sys/office/treeData3",function(data){
