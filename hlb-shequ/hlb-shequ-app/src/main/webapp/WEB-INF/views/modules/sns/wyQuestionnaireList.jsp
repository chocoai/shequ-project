...
<head>
	...
	<script type="text/javascript">
        ...
        function copy(){
        	var href = "${ctx}/sns/wyQuestionnaire/copy?gid=${gid}&name=${name}";
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sns/wyQuestionnaire/list">问卷调查表列表</a></li>
		<li><a href="${ctx}/sns/wyClassification">分类表列表</a></li>
		<li><a href="${ctx}/sns/wySubject/">题目表列表</a></li>
		<li><a href="${ctx}/sns/wyOption/">选项表列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="wyQuestionnaire" action="${ctx}/sns/wyQuestionnaire/list" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="wyQuestionnaire">
			<tr id="${wyQuestionnaire.questionnaireid}">
				...
				<td style="width: 150px;"><a>${wyQuestionnaire.title}</a></td>
				...
				<td style="width: 125px;text-align: center;"><fmt:formatDate value="${wyQuestionnaire.createtime}" pattern="yyyy-MM-dd HH:mm:SS"/></td>
				<td style="width: 125px;text-align: center;"><fmt:formatDate value="${wyQuestionnaire.updatetime}" pattern="yyyy-MM-dd HH:mm:SS"/></td>
				<shiro:hasPermission name="sns:wyQuestionnaire:edit"><td style="width: 100px;text-align: center;">
