...
<body>
	...
	<div id="content" class="row-fluid">
		...
		<div id="right">
			<iframe id="officeContent" src="${ctx}/sns/wyQuestionnaireRelease/list" width="100%" height="91%" frameborder="0"></iframe>
		</div>
	</div>
	<script type="text/javascript">
		var setting = {
			...
			callback:{onClick:function(event, treeId, treeNode){			
					...
					$('#officeContent').attr("src","${ctx}/sns/wyQuestionnaireRelease/list?gid="+id+"&name="+treeNode.name);
				}
			},
			//获取json数据  
	        async : {    
