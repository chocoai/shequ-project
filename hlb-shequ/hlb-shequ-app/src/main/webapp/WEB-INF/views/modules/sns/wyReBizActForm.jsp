...
<body>
	...
	<form:form id="inputForm" modelAttribute="wyReBizAct" action="${ctx}/sns/wyReBizAct/save" method="post" class="form-horizontal">		
		...
		<div class="control-group">
			<label class="control-label">请选择业务：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">请选择工作流程：</label>
			<div class="controls">
				<form:select path="actId" class="input-xlarge required">
					<form:option value="" label="请选择"/>
					<form:options items="${wyActDefList}" itemLabel="showName" itemValue="id" htmlEscape="false"/>
				</form:select>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
