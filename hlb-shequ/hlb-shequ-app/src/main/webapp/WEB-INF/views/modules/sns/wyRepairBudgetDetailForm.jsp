...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sns/wyRepairBudgetDetail/">物业维修预算明细列表</a></li>
		<li class="active"><a href="${ctx}/sns/wyRepairBudgetDetail/form?id=${wyRepairBudgetDetail.id}">物业维修预算明细<shiro:hasPermission name="sns:wyRepairBudgetDetail:edit">${not empty wyRepairBudgetDetail.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sns:wyRepairBudgetDetail:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="wyRepairBudgetDetail" action="${ctx}/sns/wyRepairBudgetDetail/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="sns:wyRepairBudgetDetail:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
