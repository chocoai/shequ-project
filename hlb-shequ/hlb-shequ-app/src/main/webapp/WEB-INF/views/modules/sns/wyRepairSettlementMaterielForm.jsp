...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sns/wyRepairSettlementMateriel/">物业维修核算物料明细列表</a></li>
		<li class="active"><a href="${ctx}/sns/wyRepairSettlementMateriel/form?id=${wyRepairSettlementMateriel.id}">物业维修核算物料明细<shiro:hasPermission name="sns:wyRepairSettlementMateriel:edit">${not empty wyRepairSettlementMateriel.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sns:wyRepairSettlementMateriel:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="wyRepairSettlementMateriel" action="${ctx}/sns/wyRepairSettlementMateriel/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="sns:wyRepairSettlementMateriel:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
