package com.haolinbang.common.web;
...
public class Servlets {
	...
	public static boolean isAjaxRequest(HttpServletRequest request) {
		...
		return ((accept != null && accept.indexOf("application/json") != -1 || (xRequestedWith != null && xRequestedWith.indexOf("XMLHttpRequest") != -1) || (principal != null && principal
				.isMobileLogin())));
	}
	 ...
	 * @return
	 */
	public static String getRequestUrlFull() {
		HttpServletRequest httpServletRequest = getRequest();
		String reqUrl = httpServletRequest.getScheme() + "://" + httpServletRequest.getServerName() + ":" + httpServletRequest.getServerPort() + httpServletRequest.getRequestURI();
