package com.haolinbang.modules.act.entity;
...
import com.haolinbang.common.utils.TimeUtils;
import com.haolinbang.modules.act.utils.Variable;
...
public class Act extends BaseEntity<Act> {
	...
	private int procDefVersion;// 流程版本号
	private String procDefCategory;// 流程分类
	...
	public String getProcDefName() {
		return (StringUtils.isBlank(procDefName) && procDef != null) ? procDef.getName() : procDefName;
	}
