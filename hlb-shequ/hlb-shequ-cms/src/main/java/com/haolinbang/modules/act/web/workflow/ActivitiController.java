...
import com.haolinbang.common.utils.WorkflowUtils;
import com.haolinbang.modules.act.service.activiti.WorkflowProcessDefinitionService;
import com.haolinbang.modules.act.service.activiti.WorkflowTraceService;
...
public class ActivitiController {
	...
	protected com.haolinbang.modules.act.service.activiti.WorkflowProcessDefinitionService workflowProcessDefinitionService;
	...
	protected com.haolinbang.modules.act.service.activiti.WorkflowTraceService traceService;
	...
	public void loadByDeployment(@RequestParam("processDefinitionId") String processDefinitionId, @RequestParam("resourceType") String resourceType, HttpServletResponse response)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/resource/process-instance2")
	public void loadByProcessInstance2(@RequestParam("type") String resourceType, @RequestParam("pid") String processInstanceId, HttpServletResponse response) throws Exception {
		InputStream resourceAsStream = null;
...
//		List<Map<String, Object>> activityInfos = new ArrayList<>();
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "/process/trace2")	
	public List<Map<String, Object>> traceProcess2(@RequestParam("pid") String processInstanceId) throws Exception {
		List<Map<String, Object>> activityInfos = traceService.traceProcess2(processInstanceId);
