...
import com.haolinbang.modules.cms.dao.ArticleDao;
import com.haolinbang.modules.cms.dao.ArticleDataDao;
import com.haolinbang.modules.cms.dao.CategoryDao;
...
public class ArticleService extends CrudService<ArticleDao, Article> {
	...
	public void save(Article article) {
		if (StringUtils.isNotBlank(article.getArticleData().getContent())) {
