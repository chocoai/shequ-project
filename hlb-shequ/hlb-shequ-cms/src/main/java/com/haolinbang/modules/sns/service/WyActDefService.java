...
public class WyActDefService extends CrudService<WyActDefDao, WyActDef> {
	...
	public WyActDef getWyActDefByProcDefId(String procDefId) {
		return wyActDefDao.getWyActDefByProcDefId(procDefId);
	}

	public void deleteByProcDefId(String procDefId) {
		wyActDefDao.deleteByProcDefId(procDefId);
	}

	public List<WyActDef> getWyActDefListByCatagory(String catagory) {
		return wyActDefDao.getWyActDefListByCatagory(catagory);
	}
