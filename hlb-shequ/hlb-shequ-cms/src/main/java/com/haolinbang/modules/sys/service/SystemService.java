...
public class SystemService extends BaseService implements InitializingBean {
	...
	public static boolean printKeyLoadMessage() {
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 " + Global.getConfig("systemPlatform") + "  - Copyright @ 深圳市好邻邦科技有限公司（http://wwww.oklong.com）");
		sb.append("\r\n======================================================================\r\n");
	...
	public String getUserByStaffid(int staffId) {
		return userDao.getUserByStaffid(staffId);
	}
