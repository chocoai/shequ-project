...
public class AppMenuVo implements Serializable {
	...
	private List<AppUserScope> scopeList;// 权限集合
	private String[] scopes;// 权限集合
	...
	public List<AppUserScope> getScopeList() {
		return scopeList;
	}

	public void setScopeList(List<AppUserScope> scopeList) {
	...
	public void setExecChecked(Boolean b) {
		this.execChecked = b;
	}
