...
public class AreaController extends BaseController {
	...
	@RequiresPermissions("sys:area:view")
	@ResponseBody
	@RequestMapping(value = "findPovinces")
	public List<Area> findPovinces() {
		return areaService.findPovinces();
	}
	...
	public List<Area> findCities(String id) {
		return areaService.findCities(id);
	}

	@RequiresPermissions("sys:area:view")
	@ResponseBody
	@RequestMapping(value = "findQus")
	public List<Area> findQus(String id) {
		return areaService.findQus(id);
	}
}
