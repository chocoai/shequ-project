...
public class WxNews extends DataEntity<WxNews> {
	...
	public String toString() {
		return "WxNews [account=" + account + ", keyword=" + keyword + ", precisions=" + precisions + ", title=" + title + ", description=" + description + ", content=" + content + ", picurl=" + picurl + ", isShowpic=" + isShowpic + ", url=" + url + ", click=" + click
				+ ", writer=" + writer + "]";
	}	
