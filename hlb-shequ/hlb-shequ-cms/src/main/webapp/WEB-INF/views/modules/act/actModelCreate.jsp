...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/act/model/create">新建流程图</a></li>
	</ul><br/>
	...
	<form id="inputForm" action="${ctx}/act/model/create" target="_blank" method="post" class="form-horizontal">
		...
		<!-- <div class="control-group">
			...
			<div class="controls">
				<input id="key" name="key" type="text" class="input-xlarge required" />
		...
		<div class="control-group">
			...
			<div class="controls">
				<textarea id="description" name="description" rows="4" class="input-xxlarge required"></textarea>
			</div>
		</div>
