...
<body>
	...
	<form:form id="searchForm" modelAttribute="room" action="${ctx}/sns/room/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li><label for="roomno">楼栋名称：</label>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="room">
			<tr>
				...
				<td style="text-align:center;"><fmt:formatDate value="${room.terminationdate}" pattern="yyyy-MM-dd HH:mm:SS"/></td>
				<%-- <td><a>${room.memberid}</a></td> --%>
				<td><a>${room.membername}</a></td>
				<td style="text-align:center;"><fmt:formatDate value="${room.createtime}" pattern="yyyy-MM-dd HH:mm:SS"/></td>
				<td style="text-align:center;"><fmt:formatDate value="${room.updatetime}" pattern="yyyy-MM-dd HH:mm:SS"/></td>
				<shiro:hasPermission name="sns:room:edit"><td style="text-align:center;">
