				...
				<div class="tab-content">
					<div class="tab-pane active" id="panel-856083">
						...
						<div>
							...
							<label for="type_0" id="label-selectCandidate"><h4>处理人</h4></label>
						...
						<div>
							...
							<label for="type_2"><h4>发起人</h4></label>
						</div>
						...
						<div>
							...
							<label for="type_1" id="label-selectHistoryTaskHandlePerson"><h4>历史任务处理人</h4></label>
