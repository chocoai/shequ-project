			...
			<div class="tabbable" id="tabs-59696">
				...
				<div class="tab-content">
					<div class="tab-pane active" id="panel-856083">
							...
							<br/>
							<!-- <label class="control-label">通知方式:</label><br/>	 -->	
							<c:forEach items="${createlist}" var="wyBizHandler" varStatus="status">			
							<div class="controls">
								<input id="roleIdList_${wyBizHandler.code}" name="createHandler" class="required" type="checkbox" value="${wyBizHandler.handlerInstance}" ${wyBizHandler.checked?'checked':''}><label for="roleIdList_${wyBizHandler.code}">${wyBizHandler.handlerName}</label>
							</div>
							</c:forEach>
							<br/>
							<div class="control-group"></div>
							<br/>
							<!-- <label class="control-label">指定待办人:</label><br/>		 -->
							<c:forEach items="${createlist1}" var="wyBizHandler" varStatus="status">			
							<div class="controls">
								<input id="roleIdList_${wyBizHandler.code}" name="createHandler" class="required" type="checkbox" value="${wyBizHandler.handlerInstance}" ${wyBizHandler.checked?'checked':''}><label for="roleIdList_${wyBizHandler.code}">${wyBizHandler.handlerName}</label>
							</div>
							</c:forEach>
					...
					<div class="tab-pane" id="panel-320647">
						...
						<!-- <div class="control-group"> -->
							...
							<div class="controls">
								<input id="jobHandler_${wyBizHandler.code}" name="jobHandler" class="required" type="checkbox" value="${wyBizHandler.handlerInstance}" ${wyBizHandler.checked?'checked':''}><label for="jobHandler_${wyBizHandler.code}">${wyBizHandler.handlerName}</label>
							</div>
							</c:forEach>
							<br/>
							<div class="control-group"></div>
							<br/>
							<!-- <label class="control-label">指定待办人:</label><br/>		 -->
							<c:forEach items="${createJoblist1}" var="wyBizHandler" varStatus="status">			
							<div class="controls">
								<input id="jobHandler_${wyBizHandler.code}" name="jobHandler" class="required" type="checkbox" value="${wyBizHandler.handlerInstance}" ${wyBizHandler.checked?'checked':''}><label for="jobHandler_${wyBizHandler.code}">${wyBizHandler.handlerName}</label>
							</div>
							</c:forEach>
					...
					<div class="tab-pane" id="panel-123456">
						<!-- <div class="control-group"> -->
							...
							<div class="controls">
								<input id="completeHandler_${wyBizHandler.code}" name="completeHandler" class="required" type="checkbox" value="${wyBizHandler.handlerInstance}" ${wyBizHandler.checked?'checked':''}><label for="completeHandler_${wyBizHandler.code}">${wyBizHandler.handlerName}</label>
							</div>
							</c:forEach>
							<br/>
							<div class="control-group"></div>
							<br/>
							<!-- <label class="control-label">指定待办人:</label><br/>		 -->
							<c:forEach items="${completelist1}" var="wyBizHandler" varStatus="status">			
							<div class="controls">
								<input id="completeHandler_${wyBizHandler.code}" name="completeHandler" class="required" type="checkbox" value="${wyBizHandler.handlerInstance}" ${wyBizHandler.checked?'checked':''}><label for="completeHandler_${wyBizHandler.code}">${wyBizHandler.handlerName}</label>
							</div>
							</c:forEach>
