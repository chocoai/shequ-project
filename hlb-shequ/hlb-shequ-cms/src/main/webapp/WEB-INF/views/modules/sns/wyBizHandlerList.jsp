	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="wyBizHandler">
			<tr>
				...
				<td style="text-align: center;"><a href="${ctx}/sns/wyBizHandler/form?id=${wyBizHandler.id}">
					<fmt:formatDate value="${wyBizHandler.updateDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</a></td>
				<td>
					${wyBizHandler.remarks}
				</td>
				<shiro:hasPermission name="sns:wyBizHandler:edit"><td style="text-align: center;">
