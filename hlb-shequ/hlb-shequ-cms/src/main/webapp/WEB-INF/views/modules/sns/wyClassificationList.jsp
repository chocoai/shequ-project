...
<body>
	...
	<form:form id="searchForm" modelAttribute="wyClassification" action="${ctx}/sns/wyClassification/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li class="btns">
				<shiro:hasPermission name="sns:wyClassification:edit">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>创建时间</th>
				<th>更新时间</th>
				<shiro:hasPermission name="sns:wyClassification:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="wyClassification">
			<tr id="${wyClassification.classificationid}">
				...
				<td><a>${wyClassification.title}</a></td>
				<td><a>${wyClassification.weight}</a></td>
				...
				<td><fmt:formatDate value="${wyClassification.createtime}" pattern="yyyy-MM-dd HH:mm:SS"/></td>
				<td><fmt:formatDate value="${wyClassification.updatetime}" pattern="yyyy-MM-dd HH:mm:SS"/></td>
				<shiro:hasPermission name="sns:wyClassification:edit">
					<td>
