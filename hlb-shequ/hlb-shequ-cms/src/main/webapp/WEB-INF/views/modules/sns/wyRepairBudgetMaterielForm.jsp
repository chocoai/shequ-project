...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sns/wyRepairBudgetMateriel/">物业维修预算物料明细列表</a></li>
		<li class="active"><a href="${ctx}/sns/wyRepairBudgetMateriel/form?id=${wyRepairBudgetMateriel.id}">物业维修预算物料明细<shiro:hasPermission name="sns:wyRepairBudgetMateriel:edit">${not empty wyRepairBudgetMateriel.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sns:wyRepairBudgetMateriel:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="wyRepairBudgetMateriel" action="${ctx}/sns/wyRepairBudgetMateriel/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="sns:wyRepairBudgetMateriel:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
