...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sns/wyQuestionnaire/">问卷调查表列表</a></li>
	...
	<form:form id="searchForm" modelAttribute="wySubject" action="${ctx}/sns/wySubject/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li class="btns">
				<shiro:hasPermission name="sns:wySubject:edit">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>创建时间</th>
				<th>更新时间</th>
				<shiro:hasPermission name="sns:wySubject:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="wySubject">
			<tr id="${wySubject.subjectid}">
				...
				<td><a>${wySubject.classificationname}</a></td>
				<td><a>${wySubject.title}</a></td>
				...
				<td><fmt:formatDate value="${wySubject.createtime}" pattern="yyyy-MM-dd HH:mm:SS"/></td>
				<td><fmt:formatDate value="${wySubject.updatetime}" pattern="yyyy-MM-dd HH:mm:SS"/></td>
				<shiro:hasPermission name="sns:wySubject:edit"><td>
