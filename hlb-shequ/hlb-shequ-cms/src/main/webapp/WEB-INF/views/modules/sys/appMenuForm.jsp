...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/appMenu/">菜单列表</a></li>
		<li class="active"><a href="${ctx}/sys/appMenu/form?id=${menu.id}&parent.id=${menu.parent.id}&sysType=${menu.sysType}">菜单<shiro:hasPermission name="sys:appMenu:edit">${not empty menu.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:appMenu:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="menu" action="${ctx}/sys/appMenu/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>
		<form:hidden path="sysType" value="${menu.sysType}"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="screenCode" htmlEscape="false" maxlength="50"/>
