...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/appRole/">应用平台角色列表</a></li>
	...
	<form:form id="inputForm" modelAttribute="appRole" action="${ctx}/sys/appRole/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<span style="font-size:14px;"><b>${fns:getDictLabel(appRole.sysType,'sys_type','')}</b></span>				
			</div>
		</div>
		<div class="control-group">
				...
				<div class="row-fluid">
					<table id="treeTable" data-toggle="table1" data-height="668" class="table table-striped table-bordered table-condensed hide">
									<thead>
										<tr>
											<th>菜单名称</th>											
											<th>查看<input type="checkbox" class="column1" onclick="toSelect(this, 1)"/></th>
											<th>新增<input type="checkbox" class="column2" onclick="toSelect(this, 1)"/></th>
											<th>修改<input type="checkbox" class="column3" onclick="toSelect(this, 1)"/></th>
											<th>删除<input type="checkbox" class="column4" onclick="toSelect(this, 1)"/></th>
											<th>执行<input type="checkbox" class="column5" onclick="toSelect(this, 1)"/></th>
											<th>审核<input type="checkbox" class="column6" onclick="toSelect(this, 1)"/></th>
											<th>打印<input type="checkbox" class="column7" onclick="toSelect(this, 1)"/></th>
											<th>导出<input type="checkbox" class="column8" onclick="toSelect(this, 1)"/></th>
											<th>导入<input type="checkbox" class="column9" onclick="toSelect(this, 1)"/></th>
										</tr>
									</thead>
									<tbody>
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:appRole:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
