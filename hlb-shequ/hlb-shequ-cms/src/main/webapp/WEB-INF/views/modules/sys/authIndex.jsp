...
<body>
	...
	<div id="content" class="row-fluid">
		...
		<div id="right">
			<iframe id="officeContent" src="${ctx}/sys/appUser/authList" width="100%" height="91%" frameborder="0"></iframe>
		</div>
	</div>
	...
	<script type="text/javascript">
		var setting = {
			...
			callback:{onClick:function(event, treeId, treeNode){			
					...
					$('#officeContent').attr("src","${ctx}/sys/appUser/authList?gid="+id+"&source="+source);
				}
			},
			//获取json数据  
	        async : {    
	            enable : true,   
	            url : "${ctx}/sys/office/subTree?gtype=1", // Ajax 获取数据的 URL 地址    
		...
		function refreshTree(selectId){
			...
			$.getJSON("${ctx}/sys/office/authTreeData?source=" + selectId,function(data){
