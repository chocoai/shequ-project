...
<head>
	...
	function roleDetail(id){
		var src = "${ctx}/sys/appRole/form?id="+id+"&isView=true";
		$.layer({
		  type: 2,
		  shade: [0.8, '#393D49'],
		  fix: false,
...
<body>
	<ul class="nav nav-tabs fix1" >
		<%-- <li><a href="${ctx}/sys/appUser/authList">用户列表</a></li> --%>
	...
	<form:form id="inputForm" modelAttribute="appMenuVo" action="${ctx}/sys/appUser/authSave" method="post" class="form-horizontal distance_fix1">
