...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/sys/role/form?id=${appRole.id}">角色<shiro:hasPermission name="sys:appRole:edit">${not empty appRole.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:appRole:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
