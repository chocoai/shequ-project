...
<html>
<head>
	<title>${fns:getConfig('systemPlatform')}</title>
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand"><span id="systemPlatform">${fns:getConfig('systemPlatform')}</span></div>
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; ${fns:getConfig('copyrightYear')} ${fns:getConfig('systemPlatform')} - Powered By <a href="http://haolinbang.oklong.com" target="_blank">好邻邦</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
