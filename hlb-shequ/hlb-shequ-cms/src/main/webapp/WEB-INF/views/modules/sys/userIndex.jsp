	...
	<div id="content" class="row-fluid">
		<div id="left" class="accordion-group">
			<div class="accordion-heading">
		    	<a class="accordion-toggle">组织机构<i class="icon-refresh pull-right" onclick="refreshTree();"></i><input type="text" name=""/></a>
		    </div>
	...
	<script type="text/javascript">
		var setting = {
			...
			callback:{onClick:function(event, treeId, treeNode){			
					...
					$('#officeContent').attr("src","${ctx}/sys/user/list2?gid="+id+"&source="+source);
				}
			},
			//获取json数据  
	        async : {    
