...
<head>
	...
	<meta name="description" content="${wxNews.description}" />
	<meta name="keywords" content="${wxNews.keyword}" />
   ...
   <div class="men_pho" id="men_pho_id" style="	z-index:10003;display:none"></div>
	...
	<div class="container" style="padding: 15px 15px 0;">
		<div class="row-fluid">
			<div class="span12">
				<div>
					<h4 id="wz_title">${wxNews.title}</h4>
					<span id="wz_date"><fmt:formatDate value="${wxNews.updateDate}" pattern="yyyy-MM-dd"/></span>
					<a class="activity-meta" href="weixin://addfriend/chinatea2014" onclick="men_pho_cli2()"> 
						<span class="text-ellipsis">${wxNews.description}</span> <i class="icon_link_arrow"></i>
					</a>
				</div>
				<div class="wz_fengmian">
					<img width="100%" src="${wxNews.picurl}" ></img>
				</div>
				<div class="wz_content">${wxNews.content}</div>							
