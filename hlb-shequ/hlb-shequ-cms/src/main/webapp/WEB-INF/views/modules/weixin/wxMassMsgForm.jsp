...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/weixin/wxMassMsg/">群发消息记录表列表</a></li>
		<li class="active"><a href="${ctx}/weixin/wxMassMsg/form?id=${wxMassMsg.id}">群发消息记录表<shiro:hasPermission name="weixin:wxMassMsg:edit">${not empty wxMassMsg.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="weixin:wxMassMsg:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="wxMassMsg" action="${ctx}/weixin/wxMassMsg/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:hidden path="newsId" htmlEscape="false" maxlength="255" class="input-media required"/>
				<input class="btn" type="button" value="选择图文消息" onclick="selectNews()"/>
				<span id="newsArticleId-show"></span>
