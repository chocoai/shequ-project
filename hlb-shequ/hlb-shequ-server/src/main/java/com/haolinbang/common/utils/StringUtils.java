...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
	...
	public static final Logger log = LoggerFactory.getLogger(StringUtils.class);
	 ...
	 * @return
	 */
	public static String getOauthParas(String sessionid) {
		return CacheUtils.get(sessionid);
	}
