...
public class WyActRelation extends DataEntity<WyActRelation> {
	...
	private List<WyActCandidate> wyActCandidates;// 关联的候选人
	...
	public List<WyActCandidate> getWyActCandidates() {
		return wyActCandidates;
	}

	public void setWyActCandidates(List<WyActCandidate> wyActCandidates) {
		this.wyActCandidates = wyActCandidates;
	}
