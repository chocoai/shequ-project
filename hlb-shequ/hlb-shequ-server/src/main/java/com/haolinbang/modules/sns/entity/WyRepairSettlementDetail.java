 ...
 * @version 2017-05-18
 */
public class WyRepairSettlementDetail extends DataEntity<WyRepairSettlementDetail> {
	...
	public WyRepairSettlementDetail() {
		super();
	}

	public WyRepairSettlementDetail(String id){
		super(id);
	}
