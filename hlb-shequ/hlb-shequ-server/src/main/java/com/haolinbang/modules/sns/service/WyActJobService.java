...
public class WyActJobService extends CrudService<WyActJobDao, WyActJob> {
	...
	public WyActJob getWyActJobByProcdefidAndTaskidAndType(String procDefId, String taskDefinitionKey, String type) {
		return wyActJobDao.getWyActJobByProcdefidAndTaskidAndType(procDefId, taskDefinitionKey, type);
	}
