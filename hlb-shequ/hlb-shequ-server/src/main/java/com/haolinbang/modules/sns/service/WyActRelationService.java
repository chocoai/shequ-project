...
public class WyActRelationService extends CrudService<WyActRelationDao, WyActRelation> {
	...
	@Autowired
	private WyActRelationDao wyActRelationDao;
	...
	public WyActRelation getRelationCandidate(String defid, String defKey) {
		return wyActRelationDao.getRelationCandidate(defid,defKey);
	}
