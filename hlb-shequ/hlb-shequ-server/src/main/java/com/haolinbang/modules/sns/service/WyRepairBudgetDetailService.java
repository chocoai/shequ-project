...
public class WyRepairBudgetDetailService extends CrudService<WyRepairBudgetDetailDao, WyRepairBudgetDetail> {
	@Autowired
	private WyRepairBudgetDetailDao wyRepairBudgetDetailDao;
	...
	public List<WyRepairBudgetDetail> getWyRepairBudgetDetailByRepairId(String repairId) {
		return wyRepairBudgetDetailDao.getWyRepairBudgetDetailByRepairId(repairId);
	}

	public boolean deleteById(String id) {
		return wyRepairBudgetDetailDao.deleteById(id);
	}
