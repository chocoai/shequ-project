...
public class WyRepairBudgetService extends CrudService<WyRepairBudgetDao, WyRepairBudget> {
	...
	@Autowired
	private WyRepairBudgetDao wyRepairBudgetDao;
	...
	public WyRepairBudget getWyRepairBudgetByRepairId(String repairId) {
		return wyRepairBudgetDao.getWyRepairBudgetByRepairId(repairId);
	}
