...
public class SystemService extends BaseService implements InitializingBean {
	...
	public void updateUserLoginInfo(User user) {
		...
		// 更新本次登录信息
		user.setLoginIp(StringUtils.getRemoteAddr(ServletUtil.getRequest()));
	...
	public static boolean printKeyLoadMessage() {
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 " + Global.getConfig("productName") + "  - Copyright @ 好邻邦科技（http://haolinbang.oklong.com）");
		sb.append("\r\n======================================================================\r\n");
	 ...
	 * @return
	 */
	public User getUserByStaffId(String ygID) {
		return userDao.getUserByStaffId("",ygID);
	}
