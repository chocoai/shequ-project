...
public class LoginController extends BaseController {
	...
	public String login(HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		// view = "classpath:";
		// view +=
		// "jar:file:/D:/GitHub/haolinbang/src/main/webapp/WEB-INF/lib/haolinbang.jar!";
	...
	public String index(HttpServletRequest request, HttpServletResponse response) {
		...
		// try {
		// byte[] bytes =
		// com.thinkgem.haolinbang.common.utils.FileUtils.readFileToByteArray(
		// com.thinkgem.haolinbang.common.utils.FileUtils.getFile("c:\\sxt.dmp"));
