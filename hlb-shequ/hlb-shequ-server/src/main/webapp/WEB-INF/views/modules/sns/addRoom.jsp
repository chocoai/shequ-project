...
<html lang="zh-cn">
	<head>
		...
		<script src="${ctxStatic}/js/addRoom.js"></script>
	...
	<body>
		<div class="shequ-title_top">
			<div class="shequ-title_left add">
				<img src="${ctxStatic}/image/添加.png">
				<span>添加</span>
			</div>
			<div class="shequ-title_middle">房源信息</div>
		...
		<form class="building-info">
			...
			<c:forEach items="${buildings}" var="list">
				<div class="shequ-content_list">
					...
					<input type='hidden' value='${list.buildingId}' name='buildingId'></input>
					${list.wymc}
			...
			<div class="weui-search-bar" id="searchBar" style="height: 44px;position: fixed; width: 100%; z-index: 999;">
				<div class="weui-search-bar__form" style="margin: 0;">
					<div class="weui-search-bar__box">
						...
						<input type="search" class="weui-search-bar__input" id="keyword" placeholder="搜索楼盘" required="">
						<a href="javascript:" class="weui-icon-clear" id="searchClear"></a>
					</div>
					<label class="weui-search-bar__label" id="searchText">
						<i class="weui-icon-search"></i>
						<span style="line-height: 28px;">搜索楼盘</span>
					</label>
				</div>
