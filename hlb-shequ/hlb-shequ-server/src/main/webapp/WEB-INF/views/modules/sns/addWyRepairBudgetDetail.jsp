...
<form id="myform" name="myform" action="${ctx}/wuye/saveWyRepairBudgetDetail" method="post">
	<div class="weui_cells_title"><h3>添加物料详情</h3></div>	
	<div class="weui_cells weui_cells_form">	
		<div class="weui_cell">
            <div class="weui_cell_hd"><label class="weui_label">物料编号</label></div>
            <div class="weui_cell_bd weui_cell_primary">
            	<input type="hidden" name="id" value="${wyRepairBudgetDetail.id}"/>
            	<input id="repairId" type="hidden" name="repairId" value="${empty repairId ? wyRepairBudgetDetail.repairId : repairId}"/>
                <input name="materialNo" value="${wyRepairBudgetDetail.materialNo}" class="weui_input" type="text" placeholder="请输入物料编号" emptyTips="请输入物料编号" maxlength="15" required/>                
            </div>
        </div>
        <div class="weui_cell">
            <div class="weui_cell_hd"><label class="weui_label">物料名称</label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <input name="materialName"  value="${wyRepairBudgetDetail.materialName}" class="weui_input" placeholder="请输入物料名称"/>
            </div>
        </div>
        <div class="weui_cell">
            <div class="weui_cell_hd"><label class="weui_label">规格型号</label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <input name="specificationModel" value="${wyRepairBudgetDetail.specificationModel}" class="weui_input" placeholder="请输入规格型号"/>
            </div>
        </div>
        <div class="weui_cell">
            <div class="weui_cell_hd"><label class="weui_label">价格</label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <input name="price" value="${wyRepairBudgetDetail.price}" id="weui-number-input-price" class="weui_input" type="number" placeholder="请输入价格"/>
            </div>
        </div>
        <div class="weui_cell">
 			<div class="weui_cell_bd weui_cell_primary"> <p>数量</p> </div>
  			<div style="font-size: 0px;" class="weui_cell_ft">
   				...
   				<input name="num" value="${empty wyRepairBudgetDetail.num ? 0 : wyRepairBudgetDetail.num}" id="weui-number-input-num" pattern="[0-9]*" type="number" class="weui-number-input" style="width: 50px;height:28px;" value='0'  data-min="0" data-max="100" data-step="1">
        ...
        <div class="weui_cell">
            ...
            <div class="weui_cell_bd weui_cell_primary">
            	<span id="total-price">${empty wyRepairBudgetDetail.count ? 0.00 : wyRepairBudgetDetail.count}</span> 元
            </div>
        </div>        
