...
<body>
   ...
   <div style="text-align:center;">
	...
	<c:if test="${not empty wyRelationCandidate && wyRelationCandidate.allowBack}">	
		<a href="${ctx}/wuye/backTask?bizId=${wyComplain.id}&procInsId=${wyComplain.procInsId}"  class="weui_btn weui_btn_mini bg-orange f20">
			<i class="icon icon-71 f20"></i>回退
		</a>
	</c:if>
		<a href="${ctx}/wuye/fulfilTask?procInsId=${wyComplain.procInsId}&bizId=${wyComplain.id}" class="weui_btn weui_btn_mini bg-orange f20">
			已处理
		</a>
