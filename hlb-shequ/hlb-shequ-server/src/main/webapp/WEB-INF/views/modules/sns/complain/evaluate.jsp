...
<body>
<form id="evaluateFrom" name="evaluateFrom" action="${ctx}/wyComplain/evaluateSave" method="post">
	<div class="title">
		<div class="back"></div>
		<div class="titlecontent">发表评价</div>
	</div>
	<input type="hidden" name="relationId" value="${wyComplain.id}"/>
	<input type="hidden" name="title" value="${wyComplain.content}"/>
	<input id="star1" type="hidden" name="star1"/>
	<input id="star2" type="hidden" name="star2"/>
	<input id="star3" type="hidden" name="star3"/>
	<div class="info">${wyComplain.content}</div>
	<div class="content">		
