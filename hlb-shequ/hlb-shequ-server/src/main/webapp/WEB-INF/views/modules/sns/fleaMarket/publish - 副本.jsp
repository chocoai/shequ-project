...
<body>
    ...
    <div class="memberInfo">
    	...
    	<div class="avatar"><img src="${member.avatarurl}" style="width: 100%; height: 70px"></div>
    </div>
	<form id="houseRentForm">
	    ...
	    <div class="info">物品名称<input type="text" class="info1 inputstyle" name="goodsName"/></div>
	    <div class="info">物品描述<textarea id="goodsDesc" class="info1 textareastyle" rows="6" cols="3" name="goodsDesc" maxlength="300"></textarea></div>
	    <div class="info rent" style="display:block;">转让价格<input id="price" class="info2 inputstyle" name="price" onkeyup="clearNoNum(this, 'rent1')" type='number' step='0.01'/> 元</div>
