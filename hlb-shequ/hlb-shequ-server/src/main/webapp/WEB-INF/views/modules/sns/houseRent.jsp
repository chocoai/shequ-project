...
<body>
    ...
    <div class="memberInfo">
    	<div class="baseInfo">
    		<div class="info">客户名称：张三</div>
    		<div class="info">手机号码：13800138000</div>
    		<div class="info">详细地址：豪龙大厦A座16C</div>
    	</div>
	...
	<form>
		<div class="roomtype">
			<div class="fwczbt">
				<input type="radio" name="rental_type" id="rent" value="0"/>房屋出租
			</div>
			<div class="fwcsbt">
				<input type="radio" name="rental_type" id="sale" value="1"/>房屋出售
			</div>
	    </div>
	    <div class="info">发布标题<input class="info1 inputstyle" name="title"></input></div>
	    <div class="info">房屋描述<textarea class="info1" rows="6" cols="3" name="house_desc"></textarea></div>
	    <div class="info rent">月租价格<input id="rent1" class="info2 inputstyle" name="monthly_rent" onkeyup="clearNoNum(this, 'rent1')" type='number' step='0.01'></input>  元</div>
