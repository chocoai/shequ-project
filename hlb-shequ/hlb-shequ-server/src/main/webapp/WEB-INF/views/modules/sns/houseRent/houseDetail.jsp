...
<head>
	...
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<script type="text/javascript">
			...
			var temp_publisherRelation = "${houseRent.memberId}";
			var temp_relationId = "${houseRent.id}";
		</script>
...
<body>
	...
	<div class="baseInfo">
		<div class="member">
			<div class="info1">			
				<img src="${houseRent.member.avatarurl}" style="width: 40px;height: 40px;    -webkit-border-radius: 50%;">			
			</div>
			<div class="info2">
	...
	<div class="content">
		<pre>${houseRent.houseDesc}</pre>
	</div>
	<div class="imgList1">
	<c:forEach items="${houseRent.imgList}" var="img" varStatus="stat">
	...
	<div class="lmcontent">
		...
		<div class="message">
			<div class="message1" onclick="fillname(this)">
				...
				<div class="content">管家很棒，随叫随到的很满意哦！有问题找管家管家很耐心的解决了！</div>
				<div class="time">3天前</div>
			</div>
			<div class="message2" onclick="fillname(this)">
				<div class="message11">
					<div class="avatar1"><img src="${ctxStatic}/image/avatar.png" class="per1"></div>
					<div class="username color">myshare123</div>
				</div>
				<div class="content">
				<span>回复@zjl51961523</span>
				你住了几天？
				</div>
		...
		<c:if test="${houseRent.id%2 ==1}">
		<div class="message">
			<div class="message1" onclick="fillname(this)">
				<div class="message11">
					<div class="avatar1"><img src="${ctxStatic}/image/avatar.png" class="per1"></div>
					<div class="username">林飞</div>
				</div>
				<div class="content">房子很nice。什么都有，玩的很happy。有机会还会来玩。</div>
				<div class="time">2天前</div>
			</div>
			<div class="message2" onclick="fillname(this)">
				<div class="message11">
					<div class="avatar1"><img src="${ctxStatic}/image/avatar.png" class="per1"></div>
					<div class="username color">gogoCod</div>
				</div>
				<div class="content">
				<span>回复@林飞:</span>
					班级聚会去很赞
		...
		<div class="reply1">
			<div class="replycontent">
				...
				<input id="bizType" type="hidden" value="house_rent"></input>
