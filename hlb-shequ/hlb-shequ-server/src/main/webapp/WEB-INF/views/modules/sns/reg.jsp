...
<html lang="zh-cn">
	<head>
        ...
        <script src="${ctxStatic}/js/reg.js"></script>
	...
	<div class="bgf search">	
	  <ul>
	    <a id="select-on-1" href="#" class="on" onclick="selectTab(1);">住户</a>
	    <a id="select-on-2" href="#" onclick="selectTab(2);" class="">关联人</a>
	  </ul>
	</div>
	...
	<form id="reg-form" class="reg-form" target="x-frame" method="post" >
		...
		<div class="line padding border-bottom">
			<span id="mainMemberPhone-span" style="display:none;">
			<span class="x3"><label>住户手机</label></span>
			<span class="x8"><input id="mainMemberPhone" type="text" class="text-input" name="mainMemberPhone" placeholder="请输入住户手机号码" maxlength=11 /></span>
			</span>
			<input id="parentMemberId" type="hidden" name="parentMemberId">
			<span id="memberName-span">
			<span class="x3"><label>住户名称</label></span>
			<span class="x8"><input id="memberName" type="text" class="text-input" name="memberName" placeholder="请输入姓名"></span>
			</span>
		</div>	
		<%--<div class="line padding border-bottom">
			<span id="m_mainSmscode-span" style="display:none;">
				<span class="x3"><label>验 证 码</label></span>
				<span class="x5"><input id='mainSmscode' type="text" class="text-input" name="mainSmscode" placeholder="请输入短信验证码" maxlength=6></span>
				<span class="x3"><button id="m_mainSmscode" type="button" class="button button-little bg-dot m_zcyz" disabled="disabled">获取验证码</button></span>
				<span class="x1">
					<img id="mainSmscode-duigou" src="${ctxStatic}/image/duigou.png" style="height:20px;display:none;"/>
					<img id="mainSmscode-cha" src="${ctxStatic}/image/cha.png" style="height:20px;display:none;"/>
				</span>
			</span>
			<span id="idNo-span">
				<span class="x3"><label>证件号码</label></span>
				<span class="x8"><input id="idNo" type="text" class="text-input" name="idNo" placeholder="请输入身份证号码" maxlength=18 /></span>
				<span class="x1">
				<img id="idNo-duigou" src="${ctxStatic}/image/duigou.png" style="height:20px;display:none;"/>
				<img id="idNo-cha" src="${ctxStatic}/image/cha.png" style="height:20px;display:none;"/>
				</span>
			</span>		
		</div>	
		--%><div class="line padding border-bottom">
