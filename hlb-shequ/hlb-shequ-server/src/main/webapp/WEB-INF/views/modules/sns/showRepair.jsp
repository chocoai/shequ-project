    ...
    <div class="content1">
    	<form id="repairs-form" method="post">
    		<div class="area">
    			...
    			<input class="private" type="radio" name="pri" value="1" disabled="true">
    			<span>私人区域</span>
    			<input class="public" type="radio" name="pub" value="0" disabled="true">
    			<span>公共区域</span>
    		</div>
...
<script type="text/javascript">
	function setAssigee(){
		window.location.href="${ctx}/wuye/claim?bizId=${wyRepair.id}&procInsId=${wyRepair.procInsId}";
	}
	function completeTask(isvalid){
		window.location.href="${ctx}/wuye/completeTask?procInsId=${wyRepair.procInsId}&bizId=${wyRepair.id}&isvalid="+isvalid;
	}
