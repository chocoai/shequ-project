...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sns/wyBizForm/">业务表单定义列表</a></li>
		<li class="active"><a href="${ctx}/sns/wyBizForm/form?id=${wyBizForm.id}">业务表单定义<shiro:hasPermission name="sns:wyBizForm:edit">${not empty wyBizForm.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sns:wyBizForm:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="wyBizForm" action="${ctx}/sns/wyBizForm/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">formid自定义，有实际含义：</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="formType" htmlEscape="false" maxlength="10" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
