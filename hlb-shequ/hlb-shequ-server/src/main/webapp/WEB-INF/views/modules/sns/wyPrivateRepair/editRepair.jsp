...
<head>
	...
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <link rel="stylesheet" href="${ctxStatic}/jqweui/css/weui.min.css">
		<link rel="stylesheet" href="${ctxStatic}/jqweui/css/jquery-weui.css">
		<link rel="stylesheet" href="${ctxStatic}/jqweui/css/demos.css">
        
        <script src="${ctxStatic}/jqweui/js/jquery-2.1.4.js"></script>
		<script src="${ctxStatic}/jqweui/js/fastclick.js"></script>
		<script>
		  $(function() {
		    FastClick.attach(document.body);
		  });
		</script>
		<script src="${ctxStatic}/jqweui/js/jquery-weui.js"></script>
    ...
    <div class="content1">
    	<form id="repairs-form" method="post">
    		<div class="area">
                ...
                <input id="repair_type_1" class="private" type="radio" name="repairtype" value="1" ${(wyRepair.repairtype eq '1')?'checked="checked"':''} disabled="disabled"/>
    			<label for="repair_type_1"><span>私人区域</span></label>
    			
    			<input id="repair_type_2" class="public" type="radio" name="repairtype" value="0" ${(wyRepair.repairtype eq '0')?'checked="checked"':''} disabled="disabled"/>
    		...
    		<div class="ordertime">
    			...
    			<div class="weui_cell_bd weui_cell_primary">
                    <input class="weui_input1" style="background: #FFF" type="text" value="<fmt:formatDate value="${wyRepair.appointmenttime}" pattern="yyyy-MM-dd HH:mm:ss"/>" id='beginTime' name="beginTime"/>
                </div>
    		</div>
    	</form>
    </div>
