...
<form id="myform" name="myform" action="${ctx}/sns/wyRepairBudgetLabor/save" method="post">
	<div class="weui_cells_title"><h3>添加工时费用</h3></div>	
	<div class="weui_cells weui_cells_form">	
		<div class="weui_cell">
            <div class="weui_cell_hd"><label class="weui_label">姓名</label></div>
            <div class="weui_cell_bd weui_cell_primary">
            	<input type="hidden" name="id" value="${wyRepairBudgetLabor.id}"/>
            	<input id="repairId" type="hidden" name="repairId" value="${empty repairId ? wyRepairBudgetLabor.repairId : repairId}"/>
                <input name="name" value="${wyRepairBudgetLabor.name}" class="weui_input" type="text" placeholder="请输入姓名" emptyTips="请输入姓名" maxlength="15" required/>                
            </div>
        </div>
        <%-- <div class="weui_cell">
            <div class="weui_cell_hd"><label class="weui_label">每小时单价</label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <input name="price"  value="${wyRepairBudgetLabor.price}" class="weui_input" placeholder="请输入每小时单价"/>
            </div>
        </div>
        <div class="weui_cell">
            <div class="weui_cell_hd"><label class="weui_label">花费小时数</label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <input name="spentHour" value="${wyRepairBudgetLabor.spentHour}" class="weui_input" placeholder="请输入花费小时数"/>
            </div>
        </div> --%>
        <div class="weui_cell">
            <div class="weui_cell_hd"><label class="weui_label">工时费</label></div>
            <div class="weui_cell_bd weui_cell_primary">
            	<input name="count" value="${wyRepairBudgetLabor.count}" class="weui_input" placeholder="请输入工时费"/>
            </div>
        </div>        
