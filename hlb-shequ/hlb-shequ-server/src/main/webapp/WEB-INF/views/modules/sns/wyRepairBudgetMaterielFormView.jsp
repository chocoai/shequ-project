...
<body ontouchstart class="page-bg">
	...
	<div class="weui-form-preview">
		<div class="weui-form-preview-hd">
			...
			<em	class="weui-form-preview-value">¥ ${wyRepairBudgetMateriel.count}</em>
		</div>
		<div class="weui-form-preview-bd">
			<p>
				<label class="weui-form-preview-label">物料编号</label> 
				<span class="weui-form-preview-value">${wyRepairBudgetMateriel.materialNo}</span>
			</p>
			<p>
				<label class="weui-form-preview-label">物料名称</label> 
				<span class="weui-form-preview-value">${wyRepairBudgetMateriel.materialName}</span>
			</p>
			<p>
				<label class="weui-form-preview-label">规格型号</label> 
				<span class="weui-form-preview-value">${wyRepairBudgetMateriel.specificationModel}</span>
			</p>
			<p>
				<label class="weui-form-preview-label">价格</label> 
				<span class="weui-form-preview-value">${wyRepairBudgetMateriel.price} 元</span>
			</p>
			<p>
				<label class="weui-form-preview-label">数量</label> 
				<span class="weui-form-preview-value">${wyRepairBudgetMateriel.num} 个</span>
			</p>
		</div>
