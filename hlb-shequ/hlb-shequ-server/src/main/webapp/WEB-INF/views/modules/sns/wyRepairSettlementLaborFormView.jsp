...
<body ontouchstart class="page-bg">
	...
	<div class="weui-form-preview">
		<div class="weui-form-preview-hd">
			...
			<em	class="weui-form-preview-value">¥ ${wyRepairSettlementLabor.count}</em>
		</div>
		<div class="weui-form-preview-bd">
			<p>
				<label class="weui-form-preview-label">姓名</label> 
				<span class="weui-form-preview-value">${wyRepairSettlementLabor.name}</span>
			</p>
			<%-- <p>
				<label class="weui-form-preview-label">每小时单价</label> 
				<span class="weui-form-preview-value">${wyRepairSettlementLabor.price}</span>
			</p>
			<p>
				<label class="weui-form-preview-label">花费小时数</label> 
				<span class="weui-form-preview-value">${wyRepairSettlementLabor.spentHour}</span>
			</p> --%>
		</div>
