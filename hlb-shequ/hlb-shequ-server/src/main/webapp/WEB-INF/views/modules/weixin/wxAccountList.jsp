...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/weixin/wxAccount/">微信公共帐号列表</a></li>
		<shiro:hasPermission name="weixin:wxAccount:edit"><li><a href="${ctx}/weixin/wxAccount/form">微信公共帐号添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="wxAccount">
			<tr>
				...
				<shiro:hasPermission name="weixin:wxAccount:edit"><td>
					...
					<a href="${ctx}/weixin/wxAccount/delete?id=${wxAccount.id}" onclick="return confirmx('确认要删除该微信公共帐号吗？', this.href)">删除</a>
